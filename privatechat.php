...
<head>
	...
	<style type="text/css">
		...
		.dark-theme .card {
  background-color: #808080; /* Light gray color for dark theme */
...
<body>
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-lg-3 col-md-4 col-sm-5 profile" style="height:100vh;  border-right:1px solid #ccc;">
				<?php
				...
				?>
					...
					<div class="mt-3 mb-3 text-center">
						...
						<h3 class="mt-2 name"><?php echo $value['name']; ?></h3>
			...
			<div class="col-lg-9 col-md-8 col-sm-7">
				...
				<div class="text-right" style="margin-top: 3px; cursor:pointer;"><button id="theme_toggle_button">
						<i id="theme_toggle_icon" class="fas fa-sun"></i> <!-- Default icon: sun -->
...
<script type="text/javascript">
                ...
                <div class="` + row_class + `">
                    <div class="col-sm-10">
						...
						if (data.file_data) {
							...
							var file_url = 'data:application/octet-stream;base64,' + file_data;
							html_data += `
                            <div>
				...
				<div class="card-header">
					<div class="row">
						<div class="col col-sm-6">
							<b id="chat_name">Chat with <span  id="chat_user_name">` + user_name + `</span></b>
						</div>
    ...
    <div class="input-group mb-3" style="height: 7vh">
        <div class="input-group-prepend">
            <button type="button" id="select_file_button" class="btn btn-primary"><i class="fa fa-file"></i></button>
        </div>
        <input type="text" class="form-control" id="message_input" name="message_input" placeholder="Write a message...">
        <input type="file" class="form-control d-none" id="file_input" name="file_input" accept="image/*, .pdf, .doc, .docx">
        <div class="input-group-append">
            <button type="submit" name="send" id="send" class="btn btn-primary"><i class="fa fa-paper-plane"></i> Send Message</button>
        </div>
    </div>
    ...
    if (isValid) {
        ...
        if (file) {
            ...
            fileReader.onload = function(e) {
                data.file_data = e.target.result;
                console.log('File data:', data.file_data); // Added console log
		...
		$(document).ready(function() {
			$(document).on('click', '#select_file_button', function() {
				$('#file_input').click(); // Trigger the file input field
			});
		});
...
<script>
	...
	document.getElementById('theme_toggle_button').addEventListener('click', function() {
		...
		var themeToggleIcon = document.getElementById('theme_toggle_icon');

		// Toggle the icon class
		if (body.classList.contains('dark-theme')) {
			// Dark theme is active, update the icon to moon
			themeToggleIcon.classList.remove('fa-sun');
			themeToggleIcon.classList.add('fa-moon');
		} else {
			// Light theme is active, update the icon to sun
