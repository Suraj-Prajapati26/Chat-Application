...
class PrivateChat
{
	...
	{
		return $this->file_data = $file_data;
	}
	...
	function save_chat()
{
    $query = "
        INSERT INTO chat_message 
            (to_user_id, from_user_id, chat_message, file_data, timestamp, status) 
            VALUES (:to_user_id, :from_user_id, :chat_message, :file_data, :timestamp, :status)
    ";
    ...
    $statement->bindParam(':file_data', $this->file_data);
